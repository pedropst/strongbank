# Generated by Django 4.0.6 on 2022-07-17 04:06

from decimal import Decimal
from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import strongbank.entities.acoes_cartao
import strongbank.entities.acoes_conta
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('limite_total', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=15)),
                ('limite_disponivel', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=15)),
                ('limite_desbloqueado', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=15)),
                ('bandeira', models.CharField(max_length=20)),
            ],
            bases=(strongbank.entities.acoes_cartao.AcoesCartao, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parcial', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=15)),
                ('dta_criacao', models.DateField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            bases=(strongbank.entities.acoes_conta.AcoesConta, models.Model),
        ),
        migrations.AddField(
            model_name='cartao',
            name='conta',
