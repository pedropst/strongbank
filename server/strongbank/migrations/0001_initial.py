    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('0', 'Credito'), ('1', 'Debito'), ('2', 'Credito e Debito')], default=0, max_length=20)),
                ...
                ('nome', models.CharField(default='', editable=False, max_length=20)),
                ('mes_validade', models.CharField(default='7', editable=False, max_length=2)),
                ('ano_validade', models.CharField(default='2022', editable=False, max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('tipo', models.CharField(choices=[('S', 'Saque'), ('D', 'Deposito'), ('T', 'Transferência'), ('C', 'Cartão')], default='S', max_length=20)),
                ('dta_criacao', models.DateField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dta_criacao', models.DateField(auto_now=True)),
                ('idfatura', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='strongbank.fatura')),
            ],
        ),
        migrations.CreateModel(
            name='Conta',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero', models.CharField(editable=False, max_length=16)),
                ('idcartao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='strongbank.cartao')),
            ],
        ),
        migrations.AddField(
            model_name='cartao',
